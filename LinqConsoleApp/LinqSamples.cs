...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task4()
        {
            var res4 = Emps.Max(emp => emp.Salary);

            var maxVal = Emps.Where(emp => emp.Salary == res4)
                 .Select(emp => new
                 {
                     name = emp.Ename,
                     salary= emp.Salary,
            ...
            maxVal.ToList().ForEach(Console.WriteLine);
        ...
        public void Task5()
        {
            ...
            res5.ToList().ForEach(Console.WriteLine);
        ...
        public void Task6()
        {
            var res6 = from emp in Emps
                      ...
                      select new
                      {
                         ...
                         Employeejob =   emp.Job,
                         Deparment = dept.Dname

                      };
            res6.ToList().ForEach(Console.WriteLine);
        ...
        public void Task7()
        {
            ...
            {
                EmployeeJob = Emps.GroupBy(emp => emp.Job),
                EmployeeNumber = Emps.GroupBy(emp => emp.Job).Count()
            });
        ...
        public void Task10()
        {
            ...
            res10.ToList().ForEach(Console.WriteLine);
